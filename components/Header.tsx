...
const Header = () => {
  return (
    <header className="z-1 sticky top-0 w-full overflow-hidden border-b bg-white px-8 py-4 lg:relative lg:flex lg:w-[130px] lg:items-center lg:justify-center lg:border-b-0 lg:border-r lg:p-0">
